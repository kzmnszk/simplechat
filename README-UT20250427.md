...
```bash
cd ~/Desktop/AI_Engineering
export npm_config_cache=~/Desktop/AI_Engineering/npm-cache
export npm_config_prefix=~/Desktop/AI_Engineering/npm-global
...
```bash
cd ~/Desktop/AI_Engineering
git clone https://github.com/kzmnszk/simplechat.git
cd simplechat
